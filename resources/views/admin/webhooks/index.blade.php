...
<div class="page-header flex justify-between items-center">
    <div>
        <h1 class="page-title"><i class="bi bi-link-45deg me-2"></i> Webhooks</h1>
...
<div class="grid-3" style="gap: 16px;">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="flex justify-between items-center mt-4">
                <a href="{{ route('admin.webhooks.show', $webhook) }}" class="btn btn-secondary btn-sm"><i class="bi bi-gear"></i> Mapear Variáveis</a>
                <form method="POST" action="{{ route('admin.webhooks.destroy', $webhook) }}" onsubmit="return confirm('Remover?')">
                    @csrf @method('DELETE')
    ...
    <div class="card" style="grid-column: 1/-1; padding: 40px; text-align: center;">
        ...
        <p>Nenhum webhook criado. Crie um para começar a receber dados de onde quiser!</p>
    </div>
    @endforelse
</div>
    ...
    <div class="modal-overlay" x-show="open" x-cloak @click.self="open=false">
        <div class="modal">
            <div class="modal-header">
                <h3 class="card-title">Novo Webhook</h3>
